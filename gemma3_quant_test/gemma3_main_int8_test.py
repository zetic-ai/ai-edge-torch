...
def main():
    ...
    print("=" * 80)
    print("Gemma3-1B Main Model - INT16 Activation / INT8 Weight Quantization")
    print("=" * 80)
    ...
    print("\n[2/5] Configuring Static INT16/INT8 Quantization...")
    print("      - Activation: INT16 (Symmetric) - for I/O compatibility")
    print("      - Weight: INT8 (Symmetric) - for model size")
    qt = quantizer.Quantizer(float_model=tflite_path)
    qt.add_static_config(
        regex=".*",
        operation_name=qtyping.TFLOperationName.ALL_SUPPORTED,
        activation_num_bits=16,  # INT16 for I/O runtime compatibility
        weight_num_bits=8,       # INT8 for smaller model size
    )
    ...
    try:
        ...
        if aot_result.models_with_backend:
            ...
            print("\n" + "=" * 80)
            print("SUCCESS: Gemma3-1B Main INT16/W8 Quantization Complete!")
            print("=" * 80)
        else:
