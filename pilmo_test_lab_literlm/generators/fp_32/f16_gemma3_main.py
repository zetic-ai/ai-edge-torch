    ...
    def forward(
        ...
        **kwargs,
        ...
        for i in range(NUM_LAYERS):
            ...
            q = q.transpose(1, 2).reshape(B, T, nh, dim)
            k = k.transpose(1, 2).reshape(B, T, ng, dim)
            v = v.transpose(1, 2).reshape(B, T, ng, dim)
...
def main():
    output_dir = (
        "/home/pilmo/workspace/ai-edge-torch/pilmo_test_lab_literlm/bin/pilmo_real_f16"
    )
