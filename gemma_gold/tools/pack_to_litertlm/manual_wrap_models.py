...
EMBEDDER_PATH = os.path.join(SOURCE_MODELS_DIR, "embedder_test_w8_i16io.tflite")
AUX_PATH = os.path.join(REF_DIR, "real_aux.tflite")
MAIN_MODEL_PATH = os.path.join(
    SOURCE_MODELS_DIR,
    "pilmo_aligned_aot.tflite",
)

# Output LiteRT-LM Paths (Generated by this script)
LITERT_LM_OUTPUT_PATH = os.path.join(FINAL_PACKAGE_DIR, "match_scale_gemma3.litertlm")
METADATA_PB_PATH = os.path.join(FINAL_PACKAGE_DIR, "match_scale_gemma3_metadata.pb")
